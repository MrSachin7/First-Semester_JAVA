...
public class MyFileHandler
{
  ...
  // Reads all lines from the file with the given file name and returns them as a String[]
  ...
  // Reads all objects from the file with the given file name and returns them as an Object[].
